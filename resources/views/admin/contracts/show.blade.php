            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
                        <div>
                            <h1 class="h3 mb-1">Thông tin hợp đồng</h1>
                            <p class="text-muted mb-0">Xem chi tiết hợp đồng kinh doanh giữa Admin và Chủ sân.</p>
                        </div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <dl class="row mb-0">
                                        ...
                                        <dt class="col-sm-4">Tiêu đề hợp đồng</dt>
                                        <dd class="col-sm-8">{{ $contract->title }}</dd>

                                        <dt class="col-sm-4">Nội dung hợp đồng</dt>
                                        ...
                                        <dt class="col-sm-4">Thời gian ký hợp đồng</dt>
