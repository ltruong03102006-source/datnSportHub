...
<main class="mx-auto max-w-7xl px-6 py-8 font-[Inter] text-slate-800">
    ...
    <div class="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.vouchers.edit', $voucher->id) }}" class="inline-flex items-center gap-2 rounded-xl bg-amber-50 border border-amber-200 px-4 py-2.5 text-sm font-bold text-amber-800 hover:bg-amber-100 transition shadow-sm">
                Chỉnh sửa voucher
            </a>
            <a href="{{ route('admin.vouchers.index') }}" class="inline-flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-bold text-slate-700 hover:bg-slate-50 transition shadow-sm">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            @if($voucher->applies_to_all_fields)
                <div class="rounded-xl bg-emerald-50 p-4 text-sm font-semibold text-emerald-700">
                    Voucher này là System Voucher và áp dụng cho tất cả cơ sở trên toàn hệ thống.
                </div>
            @endif
        </div>
    </div>
